...
function FirstTimePage() {
    ...
    const sendToServer = () => {
        ...
        console.log(user);
        // axios.post('http://127.0.0.1:8000/date/check-hebrew', { termsAccepted, selectedSide, email: userEmail })
        axios.post('http://127.0.0.1:8000/date/check-hebrew', { termsAccepted,  email: userEmail })
            .then(response => {
